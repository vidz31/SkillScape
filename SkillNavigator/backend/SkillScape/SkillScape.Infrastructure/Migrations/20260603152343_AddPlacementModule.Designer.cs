...
namespace SkillScape.Infrastructure.Migrations
{
    ...
    [Migration("20260603152343_AddPlacementModule")]
    partial class AddPlacementModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.CareerPath", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SalaryDataJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.HierarchicalQuizQuestion", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AptitudeType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TargetCareerTags")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("HierarchicalQuizQuestions");
                });
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.PeerLearningRoom", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("WhiteboardState")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
                    ...
                    b.ToTable("PeerStudyRooms", (string)null);
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.PeerRoomMessage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PeerStudyRoomMessages", (string)null);
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.PeerRoomParticipant", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PeerStudyRoomParticipants", (string)null);
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.PeerRoomTask", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PeerStudyRoomTasks", (string)null);
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.PlacementAssessment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PlacementAssessments");
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.PlacementAssessmentQuestion", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("PlacementAssessmentQuestions");
                });
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.RoleSkillProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.UserCareerProfile", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BookmarkedPaths")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("PredictedSalary")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("RecommendedCareerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SelectedHierarchy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SkillGapJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("RecommendedCareerId");

                    b.HasIndex("UserId");

                    b.ToTable("UserCareerProfiles");
                });

            modelBuilder.Entity("SkillScape.Domain.Entities.UserCustomModuleProgress", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UserCustomModuleProgressions");
                });
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.CareerPath", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.CareerPath", "ParentCareer")
                        .WithMany("SubCareers")
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.PeerLearningRoom", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.ApplicationUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.PeerRoomMessage", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.PeerLearningRoom", "Room")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.PeerRoomTask", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.ApplicationUser", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.UserCareerProfile", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.CareerPath", "RecommendedCareer")
                        .WithMany()
                        .HasForeignKey("RecommendedCareerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("RecommendedCareer");
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.UserCustomModuleProgress", b =>
                {
                    b.HasOne("SkillScape.Domain.Entities.ApplicationUser", "User")
                        .WithMany("UserCustomModuleProgresses")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SkillScape.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserCustomModuleProgresses");
